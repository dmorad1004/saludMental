    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case UserStatusRow:
            return UserStatusRow(data);
          case UserCodesRow:
            return UserCodesRow(data);
          case HospitalsRow:
            return HospitalsRow(data);
          case UserMedicalConditionsRow:
            return UserMedicalConditionsRow(data);
          case UsersRow:
            return UsersRow(data);
          case SymptomReportsRow:
            return SymptomReportsRow(data);
          case SymptomSeverityRow:
            return SymptomSeverityRow(data);
          default:
            return null;
        }
